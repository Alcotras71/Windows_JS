...
var images = function images() {
  ...
  workSection.addEventListener('click', function (e) {
    ...
    if (target && target.classList.contains('preview')) {
      Object(_modals__WEBPACK_IMPORTED_MODULE_0__["openModal"])(imgPopup, 'flex');
    ...
    if (target && target.matches('div.popup')) {
      Object(_modals__WEBPACK_IMPORTED_MODULE_0__["closeModal"])(imgPopup);
    }
  });
};
...
var marginScroll = Object(_calcScroll__WEBPACK_IMPORTED_MODULE_1__["default"])();

function openModal(selector) {
  var display = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'block';
  selector.style.display = display;
  document.body.style.marginRight = "".concat(marginScroll, "px");
